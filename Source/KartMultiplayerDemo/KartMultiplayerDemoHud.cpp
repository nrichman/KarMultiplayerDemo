...
AKartMultiplayerDemoHud::AKartMultiplayerDemoHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void AKartMultiplayerDemoHud::DrawHUD()
{
	Super::DrawHUD();
	...
	if (bWantHUD == true)
	{
		...
		AKartMultiplayerDemoPawn* Vehicle = Cast<AKartMultiplayerDemoPawn>(GetOwningPawn());
